...
export function ConcertDetails() {
  ...
  return (
    <div className="py-24 bg-gradient-to-b from-black via-purple-950/20 to-black">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-yellow-400 to-amber-600 bg-clip-text text-transparent mb-6" style={{ fontFamily: 'Cinzel, serif' }}>
            Event Highlights
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-purple-900/40 to-black/40 backdrop-blur-sm p-8 rounded-2xl border border-purple-500/20 group-hover:border-yellow-500/50 transition-all h-full flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '1px' }}>{feature.title}</h3>
                <p className="text-purple-200 flex-1" style={{ fontFamily: 'Montserrat, sans-serif' }}>{feature.description}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        >
          <h3 className="text-4xl lg:text-6xl font-bold text-center bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-12" style={{ fontFamily: 'Cinzel, serif' }}>
            Artist Lineup
          </h3>
              ...
              >
                ...
                <div className="relative bg-gradient-to-r from-purple-900/50 to-purple-800/30 backdrop-blur-sm p-6 rounded-xl border border-purple-500/30 group-hover:border-yellow-500/50 transition-all flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-white mb-1" style={{ fontFamily: 'Bebas Neue, sans-serif', letterSpacing: '1px' }}>{artist.name}</h4>
                      <p className="text-purple-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>{artist.role}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-xl font-bold text-yellow-400" style={{ fontFamily: 'Montserrat, sans-serif' }}>{artist.time}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        >
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-br from-purple-900/60 to-black/60 backdrop-blur-sm p-12 rounded-3xl border-2 border-yellow-500/30">
              <h3 className="text-4xl font-bold text-yellow-400 mb-6" style={{ fontFamily: 'Cinzel, serif' }}>🎭 Dress Code 🎭</h3>
              <p className="text-2xl text-purple-200 mb-4" style={{ fontFamily: 'Playfair Display, serif' }}>Formal Masquerade Attire Required</p>
              <p className="text-lg text-purple-300" style={{ fontFamily: 'Montserrat, sans-serif' }}>
