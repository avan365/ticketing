...
export const EventConfig = {
  ...
  branding: {
    ...
    companyName: "ADHEERAA Events",
    
    // Copyright text
    copyright: "© 2026 ADHEERAA Events. All rights reserved.",
  ...
  meta: {
    ...
    // Meta description
    description: "ADHEERAA Masquerade Night - An exclusive evening of mystery, music, and elegance. February 21, 2026 at Skyfall Rooftop Bar, Singapore.",
